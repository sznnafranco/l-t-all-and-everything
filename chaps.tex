...
\copyright\ 2025-2026 As yet unnamed and unformed charitable organization to mitigate and stop hunger and malnutrition, and other cool things. All rights reserved. minor change for upload checkl

\begin{comment}
Here is a small addition to make sure this gets published on github.
rrrrrrrrrrrrrrrrrrrr
\end{comment}

\begin{htmlonly}
  Here is an html only portion!!!
\end{htmlonly}
...
\begin{latexonly}
\includegraphics[scale=.8]{three-story.pdf}
\end{latexonly}
...
\begin{htmlonly}
\includegraphics[scale=1.2]{three-story.pdf}
%\<object data="games.pdf" type="application/pdf" width="100%" height="120%"\>
%\</object\>
%<object data="three-story.pdf" type="application/pdf" width="100%" height="120%">
%</object>
%<object data="cards-emental-physical.pdf" type="application/pdf" width="100%" height="120%">
%</object>
%<object data="cards-spiritual.pdf" type="application/pdf" width="100%" height="120%">
%</object>
%<object data="four-story.pdf" type="application/pdf" width="100%" height="120%">
%</object>
\end{htmlonly}
...
Much of the preceding seems to have gone by the wayside due to dietary discoveries having to do with rare meat, shrimp, bananas and pineappple. It needs to be rewritten. 
